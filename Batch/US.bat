...
color 79
echo.
xcopy "C:\Users\%username%\Desktop\C1SetupUtility\Files\Favorites\US\Employee Links" "C:\Users\%username%\Favorites\Links\Employee links\" /q /y
xcopy "C:\Users\%username%\Desktop\C1SetupUtility\Files\Favorites\US\Bookmarks" "C:\Users\%username%\AppData\Local\Google\Chrome\User Data\Default" /q /y
