...
Global $hButton21 = 9999, $hButton22 = 9999, $hButton23 = 9999, $hButton24 = 9999, $hButton25 = 9999, $hButton26 = 9999
Global $Gui1MenuFile = 9999, $Gui1FileExit = 9999, $Gui1MenuHelp = 9999, $Gui1MenuAbout = 9999, $Gui1MenuBug = 9999, $Gui2MenuFile = 9999, $Gui2FileExit = 9999, $Gui2MenuHelp = 9999, $Gui2MenuAbout = 9999, $Gui2MenuInfo = 9999, $Gui2MenuPro = 9999
...
Global $name, $IP, $PrinterName = 9999, $PrinterIP = 9999, $MyBox6 = 9999, $MFG = 9999, $Edit, $email, $pass, $CheckFile, $Txt
gui1()
...
SplashOff()
	...
	GUICtrlSetOnEvent(-1, "On_Button") ; Call a common button function
	$Gui1MenuBug = GUICtrlCreateMenuItem("Bug Reporter", $Gui1MenuHelp)
	GUICtrlSetOnEvent(-1, "On_Button") ; Call a common button function
...
GUICtrlSetOnEvent(-1, "On_Button") ; Call a common button function
GUICtrlSetFont(-1, 10, 800, 0, "Times New Roman")
$Label6 = GUICtrlCreateLabel("2.", 508, 284, 19, 26)
GUICtrlSetColor(-1, 0x0000FF)
GUICtrlSetBkColor(-1, 0xC0C0C0)
GUICtrlSetFont(-1, 14, 800, 0, "Times New Roman")
...
func gui6()
Opt("ExpandEnvStrings", 1)
$hGui6 = GUICreate("Bug Reporter", 535, 423, 420, 178)
$Pic1 = GUICtrlCreatePic("C:\Users\%username%\Desktop\C1SetupUtility\Files\Tools\BG.jpg", 0, 0, 534, 422)
$Pic2 = GUICtrlCreatePic("C:\Users\%username%\Desktop\C1SetupUtility\Files\Tools\Composite-One-300x280Grey.gif", 416, 80, 97, 89)
GUICtrlSetState($Pic1, $GUI_DISABLE)
GUISetFont(16, 800, 0, "Terminal")
$Label2 = GUICtrlCreateLabel("C1 Setup Utility Bug Reporter", 104, 24, 322, 26)
GUICtrlSetColor(-1, 0x0000FF)
GUICtrlSetBkColor(-1, 0xC0C0C0)
$Label3 = GUICtrlCreateLabel("Use to report bugs/issues with the utility", 152, 48, 235, 20)
GUICtrlSetFont(-1, 10, 800, 0, "Times New Roman")
GUICtrlSetColor(-1, 0x0000FF)
GUICtrlSetBkColor(-1, 0xC0C0C0)
$Label4 = GUICtrlCreateLabel("Your Email:", 64, 116, 83, 23)
GUICtrlSetFont(-1, 12, 800, 0, "Times New Roman")
GUICtrlSetBkColor(-1, 0xC0C0C0)
$email = GUICtrlCreateInput("", 152, 116, 225, 23)
GUICtrlSetFont(-1, 10, 800, 0, "Times New Roman")
$Label1 = GUICtrlCreateLabel("Issue:", 24, 176, 45, 23)
GUICtrlSetFont(-1, 12, 800, 0, "Times New Roman")
GUICtrlSetBkColor(-1, 0xC0C0C0)
$Edit = GUICtrlCreateEdit("", 24, 208, 481, 145)
GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
GUICtrlSetData(-1, "")
GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
$hButton24 = GUICtrlCreateButton("Submit", 144, 376, 75, 25)
GUICtrlSetOnEvent(-1, "On_Button") ; Call a common button function
GUICtrlSetFont(-1, 12, 800, 0, "Times New Roman")
$hButton25 = GUICtrlCreateButton("Cancel", 288, 376, 75, 25)
GUICtrlSetOnEvent(-1, "On_Button") ; Call a common button function
GUICtrlSetFont(-1, 12, 800, 0, "Times New Roman")
GUISetState()
EndFunc
